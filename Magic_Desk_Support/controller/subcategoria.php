    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="editar('.$row["cats_id"].');"  id="'.$row["cats_id"].'" class="btn btn-inline btn-primaty btn-sm ladda-button"><i class="fa fa-edit"></i></button>';
