    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="editar('.$row["prio_id"].');"  id="'.$row["prio_id"].'" class="btn btn-inline btn-primary btn-sm ladda-button"><i class="fa fa-edit"></i></button>';
