...
<html>
	...
	<title>Magic Desk Support -  Notificaciones</title>
</head>
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding" style="border: .1px solid black;">
				<table id="notificacion_data" style="border: .1px solid black;" class="table table-bordered table-striped table-vcenter js-dataTable-full">
					<thead>
						<tr>
