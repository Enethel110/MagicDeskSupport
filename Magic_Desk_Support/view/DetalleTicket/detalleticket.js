...
$(document).on("click","#btnenviar", function(){
    ...
    /* *Validamos si el summernote esta vacio antes de guardar */
...
$(document).on("click","#btncerrarticket", function(){
    /* * Preguntamos antes de cerrar el ticket */
    swal({
        title: "",
...
function mostraryvalidar(id){
    ...
    $.post("../../controller/ticket.php?op=mostrar", { tick_id : id }, function (data) {
        ...
        $('#lblnomusuario').html("<strong>By:</strong> " + data.usu_nom + ' ' + data.usu_ape);
        $('#lblfechcrea').html("<strong>On:</strong> " + data.fech_crea);


        $('#lblnomidticket').html("Detalle Ticket # "+data.tick_id);
        $('#tick_rank').val(data.tick_rank);
