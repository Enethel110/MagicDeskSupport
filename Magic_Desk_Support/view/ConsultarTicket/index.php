...
<html>
	...
	<title>Magic Desk Support - Consultar Ticket</title>
	<style>
  .invisible {
    display: none;
  }
	...
	<div class="page-content">
		...
		<header style="text-align: center;">
    		<div class="tbl">
        		<div class="tbl-row">
            		<div class="tbl-cell">
                		<h3><strong>Consultar Ticket</strong></h3>
            		</div>
        		</div>
    		</div>
		</header>
			...
			<div class="box-typical box-typical-padding" style="border: .1px solid black;">
				...
				<div class="box-typical box-typical-padding" id="table" style="border: .1px solid black;">
