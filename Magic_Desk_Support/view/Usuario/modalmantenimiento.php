            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="usu_correo" name="usu_correo" placeholder="correo@gmail.com.com" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="usu_telf" name="usu_telf" placeholder="3321640978" required>
                    </div>
