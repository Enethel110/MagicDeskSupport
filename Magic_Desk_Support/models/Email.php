...
require '../public/include/vendor/autoload.php';
...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'magicdeskteam@gmail.com';
    protected $gContrasena = 'dsesjuqahmnhqdbm';
    ...
    public function ticket_abierto($tick_id){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/emails/NuevoTicket.html'); /**  Ruta del template en formato HTML */
    ...
    public function ticket_cerrado($tick_id){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/emails/CerradoTicket.html'); /**  Ruta del template en formato HTML */
        /**  parametros del template a remplazar */
        $cuerpo = str_replace("xnroticket", $id, $cuerpo);
        $cuerpo = str_replace("lblNomUsu", $usu, $cuerpo);
        $cuerpo = str_replace("lblTitu", $titulo, $cuerpo);
    ...
    public function ticket_asignado($tick_id){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/emails/AsignarTicket.html'); /**  Ruta del template en formato HTML */
        /**  parametros del template a remplazar */
        $cuerpo = str_replace("xnroticket", $id, $cuerpo);
        $cuerpo = str_replace("lblNomUsu", $usu, $cuerpo);
        $cuerpo = str_replace("lblTitu", $titulo, $cuerpo);
    ...
    public function ticket_comentario($tick_id){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/emails/ComentarioTicket.html'); /**  Ruta del template en formato HTML */
        /**  parametros del template a remplazar */
        $cuerpo = str_replace("xnroticket", $id, $cuerpo);
        $cuerpo = str_replace("lblNomUsu", $usu, $cuerpo);
        $cuerpo = str_replace("lblTitu", $titulo, $cuerpo);
    ...
    public function recuperar_contrasena($usu_correo){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/emails/RecuperarContra.html'); /**  Ruta del template en formato HTML */
        /** parametros del template a remplazar */
